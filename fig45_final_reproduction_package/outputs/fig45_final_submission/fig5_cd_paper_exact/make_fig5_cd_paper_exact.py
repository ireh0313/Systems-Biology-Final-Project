#!/usr/bin/env python3
"""Create paper-style Figure 5C/D A-substitution zoom panels."""
...
OUT = ROOT / "outputs" / "fig45_final_submission" / "fig5_cd_paper_exact"
...
PANELS = [
    ("C", "CRE1", "11A", "scanmut_single_pos_11_A", 11, 8, 22, 20, 45),
    ("C", "CRE1", "14A", "scanmut_single_pos_14_A", 14, 8, 22, 20, 45),
    ("C", "CRE1", "17A", "scanmut_single_pos_17_A", 17, 8, 22, 20, 45),
    ("D", "CRE4", "69A", "scanmut_single_pos_69_A", 69, 66, 80, 78, 102),
    ("D", "CRE4", "72A", "scanmut_single_pos_72_A", 72, 66, 80, 78, 102),
    ("D", "CRE4", "75A", "scanmut_single_pos_75_A", 75, 66, 80, 78, 102),
]
...
def main() -> None:
    ...
    sites.to_csv(OUT / "fig5_cd_variant_tfbs_occupancy_sites.csv", index=False)
    ...
    svg = OUT / "fig5_cd_paper_exact.svg"
    svg_4x = OUT / "fig5_cd_paper_exact_4x.svg"
    ...
    summary.to_csv(OUT / "fig5_cd_paper_exact_metrics.csv", index=False)
    print(svg)
