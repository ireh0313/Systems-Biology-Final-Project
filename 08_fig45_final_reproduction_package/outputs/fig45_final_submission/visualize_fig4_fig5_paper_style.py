#!/usr/bin/env python3
"""Create the paper-style Fig. 4 and Fig. 5 reproduction SVGs.

Run from the project root:

    /Users/jisoochoi/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/bin/python3 \
        outputs/fig45_final_submission/visualize_fig4_fig5_paper_style.py

Outputs are written to:

    outputs/fig45_paper_style/fig4_paper_style.svg
    outputs/fig45_paper_style/fig5_paper_style.svg

This script reproduces the final project visualization plates:

    Fig. 4: A-F, J, L, M in the paper-style plate
    Fig. 5: A-K in the paper-style plate

Note: Fig. 4 G-I and K are the paper's linear QSAM panels. They are not
included here because the final corrected reproduction package focuses on the
thermodynamic 4TF_self model outputs and did not recompute QSAM.
"""
