...
- 4TF model A/T substitution Pearson r: `0.876206`
...
| scanmut_single_pos_14_A | `-0.304006` | `-0.534272` |
| scanmut_single_pos_14_T | `-0.377070` | `-0.206852` |
| scanmut_single_pos_72_A | `-1.888969` | `-1.208823` |
| scanmut_single_pos_72_T | `-1.434403` | `-0.842974` |
