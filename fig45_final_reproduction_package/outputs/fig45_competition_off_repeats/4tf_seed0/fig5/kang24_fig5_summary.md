...
- 4TF model A/T substitution Pearson r: `0.868870`
...
| scanmut_single_pos_14_A | `-0.304006` | `-0.350700` |
| scanmut_single_pos_14_T | `-0.377070` | `-0.328674` |
| scanmut_single_pos_72_A | `-1.888969` | `-1.358228` |
| scanmut_single_pos_72_T | `-1.434403` | `-0.975664` |
